...
var config = {
    src: "https://unpkg.com/anqila-skill-static@1.0.2/img/633d3fb19fee4.png",
    rows: 15,
    cols: 7,
  },
...
document.addEventListener("pjax:success", e => {
  ...
  (ctx = canvas ? canvas.getContext("2d") : undefined), window.removeEventListener("resize", resize);
...
function createPeeps() {
  for (
    var e = config.rows, r = config.cols, t = e * r, a = img.naturalWidth / e, n = img.naturalHeight / r, o = 0;
    o < t;
    o++
  )
    allPeeps.push(
